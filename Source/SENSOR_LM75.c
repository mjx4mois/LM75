...
CHAR8S LM75_THYST_TOS_CONRTOL(CHAR8U LM75_S_ADDRESS,CHAR8U RW_BIT,CHAR8U THYST_TOS_BIT,FLOAT *LM75_HYOS_Data)
{
    ...
    */
    ...
    FLOAT  LM75_Final_Value;
		...
		/*check THYST_TOS_BIT*/
		if(THYST_TOS_BIT == LM75_THYST )
		{
			register_address = 0x02;              /*SET register address ->THYST*/
		}
		else if (THYST_TOS_BIT == LM75_TOS )
		{
			register_address = 0x03;          /*SET register address ->TOS*/
		}
		else 
		{
	             return -1;
